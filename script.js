...
function createOverlappingBackground(desktopFlag, fragmentHeight, offset, lastFragmentHeight) {
    ...
    for (let i = 0; i < fragmentCount; i++) {
        ...
        console.log('blockHeight ', blockHeight, 'currentHeight', currentHeight);
...
// адаптив
let personImg = document.querySelector('.person__img');
let mainLabelImg = document.querySelector('.main-label__img');
...
function changeElems() {
    personImg.src = './img/header_person_desktop.png';
    mainLabelImg.src = './img/header_Label Main_desktop.svg';
    locationImg.src = './img/location_img_desktop.png';
